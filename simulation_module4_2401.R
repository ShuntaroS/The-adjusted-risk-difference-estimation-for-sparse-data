...
source("04_Script/Functions/module4.R")
...
df_sim <- data
tic()
result_sim <-  mclapply(df_sim$no, function(i) {
...
df_result <- result_sim %>% bind_rows()

# df_result <- result_sim[-c(4, 5, 20, 21)] %>% 
#   bind_rows()

write_rds(df_result, "03_Output/result_module4_242016.rds")

df_result <- read_rds("03_Output/result_sim_set4_231214.rds")
